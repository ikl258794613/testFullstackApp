...
import UpLoadImgInput from '../components/UpLoadImgInput'
...
const Admin = () => {
  ...
  const onSubmit = async (data) => {
    ...
    console.log('img:', img)
    // @ts-ignore
    const imageUrl = `https://${process.env.NEXT_PUBLIC_AWS_S3_BUCKET_NAME}.s3.amazonaws.com/${img.name}`
    ...
    <div className='container mx-auto max-w-md py-12'>
      ...
      >
        ...
        <label className='block'>
          ...
          <UpLoadImgInput file={image} updateFunction={handleImage} />
        </label>
